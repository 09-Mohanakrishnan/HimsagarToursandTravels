...
import { Compass, Shield, Users, Map, Globe, Leaf, Award, ArrowRight, Instagram, Linkedin, Twitter } from "lucide-react";
    ...
    <div className="pt-40 pb-0 bg-[#fcfdfd] min-h-screen">
      ...
      <section className="container mx-auto px-12 mb-32">
        <header className="text-center max-w-4xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            <h4 className="text-brand-primary text-[10px] uppercase tracking-[0.4em] font-black mb-6 italic">Our Origin</h4>
            <h1 className="text-7xl md:text-9xl font-serif font-black italic tracking-tighter mb-8 text-gray-900 leading-[0.85]">The Art of <br/>Discovery</h1>
      ...
      <section className="container mx-auto px-12 mb-40">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-24 items-center">
          ...
          <div className="space-y-12">
            <h2 className="text-5xl font-serif font-black italic tracking-tighter text-gray-900 leading-tight">A Heritage of <br/>High Passes</h2>
            ...
            <div className="grid grid-cols-2 gap-10 pt-8 border-t border-gray-100">
               <div>
                  <h4 className="text-[9px] font-black uppercase tracking-[0.4em] text-brand-primary mb-2">Established</h4>
                  <p className="text-3xl font-serif font-black italic tracking-tighter text-gray-800">2010</p>
               </div>
               <div>
                  <h4 className="text-[9px] font-black uppercase tracking-[0.4em] text-brand-primary mb-2">Deployments</h4>
                  <p className="text-3xl font-serif font-black italic tracking-tighter text-gray-800">1.2K+</p>
               </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-32 bg-slate-50 rounded-[4rem] px-12 md:px-32 mb-40 container mx-auto">
         <div className="text-center mb-24">
            ...
            <h2 className="text-5xl font-serif font-black italic tracking-tighter text-gray-900">Guiding Principles</h2>
         </div>
         <div className="grid grid-cols-1 md:grid-cols-3 gap-20">
            {[
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }} key={i} className="text-center space-y-6">
                 ...
                 <h3 className="text-xl font-black uppercase tracking-tighter italic text-gray-900">{item.title}</h3>
      ...
      <section className="py-32 bg-brand-navy text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-12 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              <h4 className="text-brand-primary text-[10px] uppercase tracking-[0.4em] font-black mb-6 italic">Global Reach</h4>
              <h2 className="text-5xl md:text-7xl font-serif font-black italic tracking-tighter mb-10 leading-tight">Operating Across <br/>4 Continents</h2>
      ...
      <section className="py-40 bg-white">
        <div className="container mx-auto px-12 text-center max-w-5xl">
          ...
          <h4 className="text-brand-primary text-[10px] uppercase tracking-[0.4em] font-black mb-6 italic">Our Commitment</h4>
          <h2 className="text-5xl md:text-6xl font-serif font-black italic tracking-tighter mb-10 text-gray-900">Sustainable & Conscious Travel</h2>
      ...
      <section className="py-32 bg-gray-50 border-y border-gray-100">
        <div className="container mx-auto px-12">
          <div className="flex flex-col md:flex-row justify-between items-end mb-20">
            <div>
              <h4 className="text-brand-primary text-[10px] uppercase tracking-[0.4em] font-black mb-4 italic">The Architects</h4>
              <h2 className="text-5xl font-serif font-black italic tracking-tighter text-gray-900">Meet The Visionaries</h2>
            </div>
      ...
      <section className="py-40 bg-white text-center">
        <div className="container mx-auto px-12 max-w-4xl">
          <h2 className="text-5xl md:text-8xl font-serif font-black italic tracking-tighter text-gray-900 mb-10 leading-[0.9]">Begin Your <br/>Next Chapter</h2>
